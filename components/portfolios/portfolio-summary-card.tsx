      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="text-center md:text-left">
          <div className="flex items-center gap-2 mb-2">
            <DollarSign className="w-6 h-6 text-[#008485]" />
        ...
        <div className="text-center md:text-left">
          <div className="flex items-center gap-2 mb-2">
            <Activity className="w-6 h-6 text-[#008485]" />
            <span className="text-[#6b7280] text-lg font-medium">오늘 수익률</span>
          </div>
          <div className={`text-3xl font-bold ${totalChange > 0 ? "text-[#dc2626]" : "text-[#008485]"}`}>
            {formatPercent(totalChangePercent)}
          </div>
        </div>
        <div className="text-center md:text-left">
          <div className="flex items-center gap-2 mb-2">
            <TrendingUp className="w-6 h-6 text-[#008485]" />
