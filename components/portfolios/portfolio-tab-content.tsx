...
export function PortfolioTabContent({ portfolio, activeTab }: PortfolioTabContentProps) {
  ...
  return (
    <div className="h-full flex flex-col">
      {activeTab === "holdings" && (
        <div className="bg-[#f0f9f7] rounded-xl p-4 h-full flex flex-col">
          <h3 className="text-lg font-semibold text-[#1f2937] mb-4 flex-shrink-0">자산 구성 및 보유 종목</h3>
          ...
          <div className="flex flex-row gap-6 flex-1 min-h-0">
            ...
            <div className="w-1/3 flex-shrink-0 flex items-center justify-center py-4">
              <PortfolioPieChart
                ...
                height={`${Math.min(portfolio.holdingStocks.length * 80 + 16, 400)}px`}
              />
            </div>
            ...
            <div className="w-2/3 flex flex-col min-h-0">
              <div className="space-y-3 overflow-y-auto pr-2 flex-1">
                {portfolio.holdingStocks.map((stock, index) => (
                  <div key={index} className="flex items-center justify-between p-4 bg-white rounded-lg shadow-sm flex-shrink-0">
